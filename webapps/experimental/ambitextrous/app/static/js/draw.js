...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonImage.src = url_for('static', path='images/crayon-outline.png')

			markerImage.onload = resourceLoaded;
			// markerImage.src = "images/marker-outline.png";
			markerImage.src = url_for('static', path='images/marker-outline.png')

			eraserImage.onload = resourceLoaded;
			// eraserImage.src = "images/eraser-outline.png";
			eraserImage.src = url_for('static', path='images/eraser-outline.png')

			crayonBackgroundImage.onload = resourceLoaded;
			// crayonBackgroundImage.src = "images/crayon-background.png";
			crayonBackgroundImage.src = url_for('static', path='images/crayon-background.png')

			markerBackgroundImage.onload = resourceLoaded;
			// markerBackgroundImage.src = "images/marker-background.png";
			markerBackgroundImage.src = url_for('static', path='images/marker-background.png.png')

			eraserBackgroundImage.onload = resourceLoaded;
			// eraserBackgroundImage.src = "images/eraser-background.png";
			eraserBackgroundImage.src = url_for('static', path='images/eraser-background.png')


			crayonTextureImage.onload = resourceLoaded;
			// crayonTextureImage.src = "images/crayon-texture.png";
			crayonTextureImage.src = url_for('static', path='images/crayon-texture.png')

			outlineImage.onload = resourceLoaded;
			// outlineImage.src = "app/static/images/watermelon-duck-outline.png";
			outlineImage.src = url_for('static', path='images/watermelon-duck-outline.png')
		};
